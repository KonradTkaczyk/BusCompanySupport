...
describe UsersController do
  ...
  describe "GET ' index'" do
    ...
    describe "for logged in users" do
      before(:each) do
        ...
        second = Factory(:user, :email => "user2@gmail.com")
        third = Factory(:user, :email => "user3@gmail.com")
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "New User",:surname => "example", :email => "user@example.com",:postalcode => "99-999", :password => "foobar", :password_confirmation => "foobar" }
      end
